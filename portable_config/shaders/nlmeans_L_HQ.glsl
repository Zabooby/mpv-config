...
#ifdef LUMA_raw
#define S 3.3414293791794623
#else
#define S 2.7582254279162504
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 0.322495824496001
#else
#define SW 0.829721057696643
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 1.7287909749763721
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 1.13224665168501
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 1
#define WDT 0.37541358514556056
#define WDP 5.803885694575251
#define WDS 1.0
#else
#define WD 1
#define WDT 0.26947793137825565
#define WDP 3.7584087551040333
#define WDS 1.0
#endif
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 0.00011911204981066032
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
...
// Denoising factor (sigma, higher means more blur)
#ifdef LUMA_raw
#define S 0.6760759048194782
#else
#define S 0.5815499203176268
#endif
 ...
 */
#ifdef LUMA_raw
#define SW 2.072904783596684
#else
#define SW 2.96145504055636
#endif
...
#ifdef LUMA_raw
#define SST 1
#define SS 0.20289635200201955
#define PST 0
#define PSS 0.0
#else
#define SST 1
#define SS 0.09644906964473951
#define PST 0
#define PSS 0.0
#endif
...
#ifdef LUMA_raw
#define WD 2
#define WDT 0.08043391894306047
...
#ifdef LUMA_raw
#define SO 0.0
#define RO 1.873862444181591e-05
#define PSO 0.0
#define ASO 0.0
#else
#define SO 0.0
#define RO 4.278929451228823e-05
#define PSO 0.0
#define ASO 0.0
#endif
